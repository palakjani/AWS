      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
           ...
           <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>View Category</span></a>
              <ul class="children">
                <li><a href="categoryc.jsp">Search Category</a></li>
              </ul>
            </li>
            ...
            <li class="nav-parent"><a href=""><i class="fa fa-file-text"></i> <span> Storage</span></a>
              <ul class="children">
                <li><a href="storage.jsp">Add Storage</a></li>
                <li><a href="storage.jsp">View Storage</a></li>
              
              </ul>
              
                
            <li class="nav-parent"><a href="index.html"><i class="fa fa-file-text"></i> <span>Version</span></a></li>
          
            <li class="nav-parent"><a href="index.html"><i class="fa fa-file-text"></i> <span>Archivework</span></a></li>
          
          
            <li class="nav-parent"><a href="index.html"><i class="fa fa-file-text"></i> <span>Security</span></a></li>
