  ...
  <div class="mainpanel">
    ...
    <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-8">
                      <input type="text" id="stateId" name="stateName" class="form-control" placeholder="Enter your State Name..." required />
                    </div> 
                  </div>
 				 <div class="form-group">
                    <label class="col-sm-3 control-label">Description <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                      <textarea name="stateDescription" rows="5" class="form-control" placeholder="Type your Description..." required></textarea>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
