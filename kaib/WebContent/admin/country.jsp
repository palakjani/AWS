              ...
              <div class="panel-body ">
                ...
                <form method="post" id="basicForm" action="<%=request.getContextPath()%>/countryController" class="form-horizontal">
                  <div class="form-group">
                   ...
                   <div class="col-sm-8">
                      <input type="text" id="countryId" name="countryName" class="form-control" placeholder="Enter your Country Name..." required />
                    </div> 
                  </div>
  <div class="form-group">
                    <label class="col-sm-3 control-label">Description <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                      <textarea rows="5" id="countryDescription" name="countryDescription" class="form-control" placeholder="Type your Description..." required></textarea>
                    </div>
                  </div>
